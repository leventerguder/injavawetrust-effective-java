...
public class HashTableImpl3 implements Cloneable {
...
//		}
	...
	@Override
	protected HashTableImpl3 clone() {
		try {
			HashTableImpl3 result = (HashTableImpl3) super.clone();
	...
	// To prevent this from happening , you can replace the recursion in deepCopy
	// with iteration.
